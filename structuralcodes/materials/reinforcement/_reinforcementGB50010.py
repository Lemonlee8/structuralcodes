"""The reinforcement class for GB50010 Reinforcement Material."""
...
class ReinforcementGB50010(Reinforcement):
    """Reinforcement implementation for GB50010."""
    ...
    def __init__(
        ...
        """Initializes a new instance of Reinforcement for GB50010.
    ...
    def fyd(self) -> float:
        ...
        return gb50010.fyd(self.fyk, self.gamma_s)

    @property
    def gamma_s(self) -> float:
        """The partial factor for reinforcement."""
        # if the yield strength is greater than or equal to 500 MPa,
        # the partial factor is 1.15, according to GB50010 Sec. 4.2.3
        if self.fyk >= 500:
            return 1.15
        return 1.11
    ...
    def ftd(self) -> float:
        ...
        return gb50010.fyd(self.ftk, self.gamma_s)

    def epsud(self) -> float:
        """The design ultimate strain."""
        return gb50010.epsud(self.epsuk, self.gamma_eps)
